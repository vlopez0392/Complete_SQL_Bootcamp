...
-- Challenge 1: We have two staff members (1 and 2). We want to give a bonus to the staff 
-- member that handled the most payments. (Most in terms of number of payments processed,
